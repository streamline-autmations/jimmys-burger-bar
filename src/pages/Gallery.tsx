...
const photos: GalleryPhoto[] = [
  ...
  { src: '/images/ambience-corona.jpg', caption: 'Ice-cold buckets from the Jimmy\'s bar', category: 'Drinks', tall: true },
  { src: '/images/campaign/bloody-mary.webp', caption: 'Bloody Mary with a little bite', category: 'Drinks', tall: true },
  { src: '/images/campaign/coffee-cars.webp', hoverSrc: '/images/campaign/cars-1.webp', caption: 'Coffee & Cars morning at Jimmy\'s', category: 'Coffee & Cars' },
