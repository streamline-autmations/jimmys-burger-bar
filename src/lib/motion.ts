...
// Named `fadeInUp` for historical reasons across ~35 call sites - it no longer
// translates. Opacity only, on purpose. Do not add `y` back.
...
// Child of `staggerContainer`. Also opacity-only.
